            ...
            <div class="section full mt-1">
                ...
                <div class="wide-block pt-2 pb-2">
                    ...
                    <ul class="nav nav-tabs style1" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="tab" href="#InProg" role="tab">
                                IN-PROG
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content mt-2">
                        ...
                        <div class="tab-pane fade" id="InProg" role="tabpanel">
                        <div class="section" style="margin-top:10px;">
                          <ul class="listview image-listview media mb-2">
                          <?php 
                                    $appointmentList = $portCont->myAppointmentListInprogress($code); 
                                    if (!empty($appointmentList)) {
                                        foreach ($appointmentList as $key => $value) {
                                            date_default_timezone_set('Asia/Manila');
                                            $dateToday = date('Y-m-d'); 
