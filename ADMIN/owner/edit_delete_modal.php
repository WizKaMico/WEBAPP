...
<!-- Edit -->
<div class="modal fade" id="approval_<?php echo $row['user_id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <center><h4 class="modal-title" id="myModalLabel">Approve / DisApproved</h4></center>
            </div>
            <div class="modal-body">
			<div class="container-fluid">
			<form method="POST" action="edit_approval.php">
				...
				<div class="row form-group">
					...
					<div class="col-sm-10">
					   <select class="form-control" name="service_approval"> 
					   <option value="<?php echo $row['service_approval']; ?>"><?php echo $row['service_approval']; ?> (CURRENT)</option>
